...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "An overview of my work and personnal projects.",
          section: "Navigation",
          handler: () => {
          ...
          title: "repositories",
          description: "A glimpse of my GitHub repositories.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%71%75%65%6E%74%69%6E.%67%6F%65%73%74%63%68%65%6C@%65%6E%73-%70%61%72%69%73-%73%61%63%6C%61%79.%66%72", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/qgoestch", "_blank");
        },
      },{
        id: 'social-gitlab',
        title: 'GitLab',
        section: 'Socials',
        handler: () => {
          window.open("https://gitlab.com/qgoestch", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/quentin-goestchel-3bab71133", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-2895-1089", "_blank");
        },
      },{
      id: 'light-theme',
